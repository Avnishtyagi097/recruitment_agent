...
defaults = {
    ...
    "email_log": [],
    # Assessment link tokens
    "assessment_tokens": {},  # maps token -> candidate_id
...
# ─────────────────────────────────────────────
# ASSESSMENT LINK HANDLER (Query Parameters)
# ─────────────────────────────────────────────
...
# Auto-navigate to Assessment page if candidate arrived via email link
_default_page_idx = 0
...
# ═════════════════════════════════════════════
    ...
    # Check if candidate arrived via email link
    if st.session_state.get("_arrived_via_link"):
        st.success("\u2705 **Welcome!** You arrived via your assessment invitation link. Your assessment is ready below.")
...
st.sidebar.markdown("*\u26a1 With automated email pipeline & working assessment links*")
